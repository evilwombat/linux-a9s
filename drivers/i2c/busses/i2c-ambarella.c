 ...
 *
 */
#define CONFIG_AMBALINK_LOCK

#define AMBA_IPC_MUTEX_I2C_CHANNEL2 0
#undef aipc_mutex_lock
#undef aipc_mutex_unlock

static void aipc_mutex_lock(int foo) {}
static void aipc_mutex_unlock(int foo) { }
